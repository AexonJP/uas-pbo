...
public class loginAdmin extends akun{
    ...
    public loginAdmin(int id, String username, String password){
    ...
    public void updateUI() {
        ...
        users.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                loginUser p = new loginUser (1,"123" , "123");
                p.loginUser(FormLogin.getX(),FormLogin.getY());
        ...
        cek.addActionListener(new ActionListener() {
              ...
              public void actionPerformed(ActionEvent e) {
                  //your actions
                    if (tbUser.getText().equals("p") && tbPass.getText().equals("123")){
                        new menuAdmin(1);
                        FormLogin.dispose();
